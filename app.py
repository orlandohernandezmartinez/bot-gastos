...
- categoria: una de estas opciones exactas:
  ...
  * 'trabajo' → claude, chatgpt, digital ocean, google workspace, software, celular, telcel, servidor, server, railway
...
def consulta_categoria(texto):
    ...
    categorias_map = {
        ...
        'trabajo': ['claude', 'chatgpt', 'chat', 'gpt', 'google', 'digital ocean', 'servidor', 'server', 'railway'],
